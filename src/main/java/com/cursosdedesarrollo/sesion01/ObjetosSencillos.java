...
public class ObjetosSencillos {
  public static void main(String[] args) {
    ...
    System.out.println(nuevaCadena);
    // Cuando creamos un objeto se guarda en una parte de la memoria y la referencia a esa porción
    // de memoria es lo
    // se guarda en la variable (en este caso en nuevaCadena).
    // Cuando asignamos un nuevo valor a nuevaCadena lo que sucede es que se crea un nuevo objeto en
    // otro lugar de
    // la memoria, esa referencia a esa nueva porción de memoria se guarda en la variable
    // nuevaCadena y la referencia
    // a la porción de memoria anterior se pierde.
    // El recolector de basura liberará eventualmente esa parte de la memoria ocupada por el primer
    // objeto creado
